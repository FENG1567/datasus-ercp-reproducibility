#!/usr/bin/env python3
"""Versioned entry point for the Stage 7 rc_v1_1 figure/table source release.

The data transformations remain the validated rc_v1 implementation.  This
adapter binds that implementation to the updated public rc_v1_1 contract and
...
def _parse_policy_markdown_rc_v1_1(record: dict[str, Any]) -> pd.DataFrame:
...
def _privacy_gate_rc_v1_1(frame: pd.DataFrame, filename: str) -> None:
...
def _configure_base() -> None:
    ...
    base._parse_policy_markdown = _parse_policy_markdown_rc_v1_1
    base._privacy_gate = _privacy_gate_rc_v1_1


def build_source_data(*args: Any, **kwargs: Any) -> dict[str, Any]:
    """Run the validated transformation code under the rc_v1_1 frozen bindings."""
    _configure_base()
